  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ข้อมูลครูพี่เลี้ยง</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
           ...
           <div class="card">
            <div class="card-header">
              <h3 class="card-title d-inline-block">ค้นหา ข้อมูลครูพี่เลี้ยง</h3>
            ...
            <div class="card-body">
              <table id="dataTable" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>ชื่อ</th>
                  <th>สกุล</th>
                  <th>โรงเรียนที่สังกัด</th>
                  <th>รหัสบัตรประชาชน</th>
                  <th>สาขาวิชาที่เป็นครูพี่เลี้ยง</th>
                  <th>อีเมล</th>
                  <th>เบอร์โทรศัทพ์</th>
                  <th>เลือกครูพี่เลี้ยง</th>
                </tr>
                </thead>
                <tbody>
                <?php 
