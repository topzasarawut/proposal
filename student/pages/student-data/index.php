  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ข้อมูลนักศึกษา</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
           ...
           <div class="card">
            <div class="card-header">
              <h3 class="card-title d-inline-block">ค้นหา ข้อมูลนักศึกษา</h3>
              <div class="form-group">
                  ...
                  <select class="form-control" required name="branch">
                    ...
                    <input type="submit" name="submit" class="btn btn-primary float-right" value="ค้นหา">
                </div>
            </div>
            </form>
          <!-- /.card -->
          ...
          <?php
            ...
            // echo $asd;
            // exit;
            // $sql = "SELECT * FROM `student` WHERE branch = $aaa ";
            // $sql = "SELECT * FROM `student` WHERE branch = $abc ";
            $sql = "SELECT * FROM `student` ";
            $result = $conn->query($sql);
          ?>
