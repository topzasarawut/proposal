      ...
      <div class="card card-primary">
        ...
        <form role="form" action="update.php" method="post">
          ...
          <div class="form-group">
              <label>เลือกสาย การทำงานเดิม คือ <?php echo $row['id_work']; ?></label>
              <select class="form-control" required name="id_work">
                <option value="" disabled selected>สายวิชาการ/สายสนับสนุน</option>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="birthday" id="birthday" placeholder="วันเดือนปีเกิด" value="<?php echo $row['birthday']; ?>" required>
            </div>
            <div class="form-group">
