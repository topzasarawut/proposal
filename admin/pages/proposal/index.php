        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Proposal Management</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title d-inline-block">Proposal List</h3>
          <a href="form-create.php" class="btn btn-primary float-right ">Add Proposal +</a href="">
        </div>
        <!-- /.card-header -->
        <div class="card-body">
