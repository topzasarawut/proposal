  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="card card-primary"> 
        ...
        <h3 class="card-title">เพิ่มข้อมูลงานวิจัย</h3>
        ...
        <form role="form" action="create.php" method="post"> 
          ...
          <!-- End Input Date -->
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="topic" id="topic" placeholder="ข้อข้อ" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="cash" id="cash" placeholder="งบประมาณ" required>
            </div>

            <div class="form-group">
                <label for="upload_pdf">ไฟล์แนบ Pdf</label>
                    <input type="file" class="form-control" id="upload_pdf" name="upload_pdf" onchange="readURL(this)">
            </div>

            <div class="form-group">
                <label for="upload_word">ไฟล์แนบ Word</label>
