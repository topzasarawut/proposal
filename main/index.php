        ...
        <div class="row">
              ...
              <section id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                      <div class="carousel-item active">
                          <img class="d-block w-100" src="img/proposal.png" alt="First slide">
                      </div>
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                <h6 class="card-title">ระบบส่งงานวิจัย สถาบันวิจัยและพัฒนา มหาวิทยาลัยราชภัฏชัยภูมิ</h6>

                <p class="card-text">Research submission system Research and Development Institute Chaiyaphum Rajabhat University.</p>
