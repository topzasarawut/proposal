<?php
    ...
    if(isset($_POST['submit'])){
         ...
         */
        $sqlUser = "SELECT * FROM `mentor` WHERE `username` = '".$username."'";
        $checkUser = $conn->query($sqlUser);
        if( !$checkUser->num_rows ) {
            $sql = "INSERT INTO `mentor` (`username`, `password`,`prefix`, `first_name`, `last_name`, `school`, `branch`, `email`, `telephone`, `created_at`) 
            VALUES ('".$username."', 
                    '".$passwordHashed."', 
                    '".$_POST['prefix']."', 
                    '".$_POST['first_name']."', 
                ...
                <div class="col-md-8 mx-auto mt-5 col-lg-12">
                    <div class="card border-0 shadow">
                        ...
                        <form action="" method="POST">
                            <h4 class="card-header text-center">กรอกข้อมูลเพื่อสมัครสมาชิก<br>ระบบฝึกประสบการณ์วิชาชีพครู(สำหรับครูพี่เลี้ยง)</h4>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="school" class="col-form-label">โรงเรียนที่สังกัด:</label>
                                        <input type="text" class="form-control" id="school" name="school" placeholder="โรงเรียนที่สังกัด" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-group">
                                <label>สาขาวิชาที่เป็นครูพี่เลี้ยง</label>
                                <select class="form-control" required name="branch">
                                    <option value="" disabled selected>เลือก สาขาวิชาที่เป็นครูพี่เลี้ยง</option>
